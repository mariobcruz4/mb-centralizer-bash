window.swaggerUrls = [
 ...
 {url: "./swagger-specs/music/newswagger.json", name: "New API"}, {url: "./swagger-specs/music/music2.json", name: "New API"}, {url: "./swagger-specs/music/music2.json", name: "New API"}, {url: "./swagger-specs/music/nba.json", name: "NBA}];